<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
          ...
          <li class="dropdown @if (Request::segment(1) == 'konfigurasi' and Request::segment(2) == 'setup') active @endif">
          ...
          <li class=" @if (Request::segment(1) == 'data')
          active
          @endif"><a class="nav-link" href="{{ route('data') }}"><i class="far fa-square"></i> <span>data</span></a></li>
          {{-- <li class="nav-item dropdown">
